  ...
  return (
    <div className='welcomeContainer'>
        <div className="iconContainer">
            ...
            <img className='welcomeIcon' src="./search.png" alt="magnifying glass search icon" />
        </div>
        <h1 className='headerTitle'>Save them to a list!</h1>
        <div className='listsContainer'>
            <div className="iconContainer">
                <img className='welcomeIcon' src="./gamesToPlay1.png" alt="shopping bag with controller icon" />
                <p className='headerTitle'>Games <span>{<br/>}</span> to play</p>
            </div>
            <div className="iconContainer">
                <img className='welcomeIcon' src="./gamesPlayed1.png" alt="papers with controller icon" />
